...
import org.matrixnetwork.tournaments.Util.Messages;
...
public class Tournament {
    private static Server server = MatrixTournaments.getPlugin().getServer();
    ...
    private void orderPairs(List<PlayerData> list) {
        ...
        if(toOrder.size() % 2 != 0) {
            ...
            MatrixTournaments.getPlugin().getServer().broadcastMessage(ChatColor.AQUA + toRemove.getPlayer().getName() + " will skip the round, uneven amount of players.");
